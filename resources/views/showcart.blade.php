...
<html lang="en">
  ...
  <head>
    ...
    <title>FoodFood - Restaurant HTML Template</title>
<!--
...
@foreach($data as $data)
            ...
            <td>
                ...
                <td>
                    <input type="text" name="quantity[]" value="{{$data->quantity}}" hidden="">&nbsp
                    {{$data->quantity}}
                </td>
...
<tr style="position: relative; top: -60px; right: -360px;">
                <td>
                    <a href="{{route('remove',$data2->id)}}" class="btn btn-warning">Remove</a>
                </td>
</tr>
@endforeach
            </tr>
